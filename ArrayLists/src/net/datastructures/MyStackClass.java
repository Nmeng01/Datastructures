...
public class MyStackClass<E> implements Stack<E> {
	/** Default array capacity. */
	  ...
	  public MyStackClass() { this(CAPACITY); }  // constructs stack with default capacity
	  ...
	  public MyStackClass(int capacity) {        // constructs stack with given capacity
